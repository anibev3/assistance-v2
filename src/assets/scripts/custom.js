...
$(document).ready(function () {
  ...
  function init_template() {
    ...
    function removeTransitions() {
      $("body").append(
        '<style id="transitions-remove">.btn, .header, #footer-bar, .menu-box, .menu-active, #page, .page-content{transition:all 0ms ease!important;}</style>'
      );
      setTimeout(function () {
        allowTransitions();
      }, 10);
    ...
    function activate_geolocation() {
      if ("geolocation" in navigator) {
        $(".location-support").html(
          'Votre navigateur et votre appareil <strong class="color-green2-dark">supportent</strong> la Géolocation.'
        );
      } else {
        $(".location-support").html(
          'Votre navigateur et votre appareil <strong class="color-red2-dark">ne supportent pas</strong> la Géolocation.'
        );
      }
      function geoLocate() {
        ...
        function success(position) {
          ...
          $(".location-map")
            ...
            .after(
              " <a href=" +
                mapLinkAddress +
                ' class="btn btn-full btn-m bg-red2-dark rounded-xs text-uppercase font-900 mb-n1 mt-3">Voir sur Google Maps</a>'
            );
        }
        function error() {
        ...
        if (!navigator.geolocation) {
          ...
          locationCoordinates.textContent = "Localisation";
    ...
    if (!offlineAlerts.length) {
      $("body").append(
        '<p class="offline-message bg-red2-dark color-white center-text uppercase ultrabold">Aucune connexion internet détectée</p> '
      );
      $("body").append(
        '<p class="online-message bg-green1-dark color-white center-text uppercase ultrabold">Vous êtes de retour en ligne</p>'
      );
    }
    ...
    function sharingLinks() {
      ...
      $(".shareToCopyLink").on("click", function (element) {
        $(this).parent().find("p").html("Lien copié");
        ...
        setTimeout(function () {
          ...
          $(".shareToCopyLink")
            .removeClass("bg-green1-dark")
            .addClass("bg-blue2-dark");
      ...
      function n(n, r) {
        ...
        e("#" + n + " .requiredField").each(function (i) {
          if (
            ...
            e("#" + e(this).attr("id") + "Erreur").fadeIn(300);
            return false;
          }
        ...
        if (pieChart.length) {
          var pieDemoChart = new Chart(pieChart, {
            ...
            data: {
              ...
              datasets: [
                {
                  backgroundColor: ["#893bdd", "#4FC1E9", "#A0D468"],
    ...
    function shape_changer() {
      ...
      $(document).ready(function () {
        $("#shape-cut-left").on("click", function () {
          $(".header-card")
            .removeClass("shape-rounded shape-cut-right")
            .addClass("shape-cut-left");
          $(".footer-card")
            .removeClass("shape-rounded shape-cut-right")
            .addClass("shape-cut-left");
        });
        $("#shape-cut-right").on("click", function () {
          $(".header-card")
            .removeClass("shape-rounded shape-cut-left")
            .addClass("shape-cut-right");
          $(".footer-card")
            .removeClass("shape-rounded shape-cut-left")
            .addClass("shape-cut-right");
        });
        $("#shape-rounded").on("click", function () {
          $(".header-card")
            .removeClass("shape-cut-left shape-cut-right")
            .addClass("shape-rounded");
          $(".footer-card")
            .removeClass("shape-cut-left shape-cut-right")
            .addClass("shape-rounded");
        });
    ...
    if (window.location.protocol === "file:") {
      $("a").on("mouseover", function () {
        console.log(
          "Vous voyez ces erreurs car votre fichier se trouve sur votre ordinateur local. Pour des simulations réelles, veuillez utiliser un serveur en direct ou un serveur local tel que AMPPS ou WAMPP ou simulez un aperçu en direct à l'aide d'un éditeur de code tel que http://brackets.io (c'est 100 % gratuit) - Les fonctions PWA et les transitions de page AJAX ne feront que travailler dans ces scénarios."
        );
      });
    }
    ...
    function activate_pageGreeting() {
      ...
      var greetingMorning = "Bonjour";
      var greetingAfternoon = "Bonjour";
      var greetingEvening = "Bonsoir";
    ...
    if (visitDetection.length) {
      ...
      if (!readCookie("azure_accept_cookie")) {
        ...
        createCookie(
          "azure_accept_cookie",
          "<br>Votre dernière visite était le " + strDate + " at " + strTime,
          1
        );
      } else {
      ...
      colorsArray.forEach(function (colorValue) {
        $(".generated-styles").append(
          '[data-feather-bg="' +
            colorValue[0] +
            '-fade-dark"]{ fill: ' +
            HEXtoRGBA(colorValue[2]) +
            '!important;} [data-feather-bg="' +
            colorValue[0] +
            '-fade-light"]{ fill: ' +
            HEXtoRGBA(colorValue[1]) +
            "!important;}"
        );
      });
      colorsArray.forEach(function (colorValue) {
  ...
  if (isDevelopment === true) {
    if (!$(".reloader").length) {
      $("body").append(
        '<a href="#" class="reloader" style="position:fixed; background-color:#000; color:#FFF; z-index:9999; bottom:80px; left:50%; margin-left:-105px; border-radius:10px; width:210px; line-height:40px; text-align:center;">Mode développeur - Appuyez pour recharger</a>'
      );
    }
